{
  ...
  inputs = {
    ...
    base1t.url               = "github:sixears/base1t/r0.0.5.16";
    ...
    non-empty-containers.url = "github:sixears/non-empty-containers/r1.4.3.17";
    quasiquoting.url         = "github:sixears/quasiquoting/r1.0.1.17";
