{
  ...
  inputs = {
    ...
    base1t.url               = "github:sixears/base1t/r0.0.5.17";
    exited.url               = "github:sixears/exited/r1.0.4.14";
    ...
    non-empty-containers.url = "github:sixears/non-empty-containers/r1.4.3.18";
    quasiquoting.url         = "github:sixears/quasiquoting/r1.0.1.18";
    tasty-plus.url           = "github:sixears/tasty-plus/r1.5.2.13";
